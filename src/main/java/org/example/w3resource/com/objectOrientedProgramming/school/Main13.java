...
public class Main13 {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Ricky", 15);
        Student student2 = new Student("Karolina", 16);
        Student student3 = new Student("Felicia", 15);
        Student student4 = new Student("Norbert", 16);
        ...
        Teacher teacher1 = new Teacher("Amelia", "Math");
        Teacher teacher2 = new Teacher("Elise", "English");
        Teacher teacher3 = new Teacher("Angelika", " Science");
